...
xG = sim.yRate_rad_s; %(rad/s) x-axis gyrometer angular velocity
delta_a = sim.delta_e; %[-1,1] aileron command
...
b0 = -75; %Guess the numerator coefficient (Your assignment is to find this!)
a0 = 20; %Guess the denominator coefficient (Your assignment is to find this!)
